...
4. Next to the code-chunk option `#| eval:` change the value from `false` to `true` (**Info: This tells are to eval(uate) the code-chunk on render**)
...
9. **Push:** Push changes to the remote repository (i.e. GitHub)s
